...
%   a region containing water and void regions
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% Define geometry
x = [0 5e-3 6e-3 dist];
y = [0 9e-3 11e-3 19.5e-3 21e-3 dist];
i = [1];
j = [1];
for m = 2:4
...
% Place material
site('regn', 'watr');
site('regn', 'void', i(2), i(3),j(1),j(2));
site('regn', 'void', i(2), i(3),j(3),j(4));
site('regn', 'void', i(2), i(3),j(5),j(6));
